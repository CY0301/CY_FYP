...
export function TypingDNA() {
    if (TypingDNA.initialized !== true) {
      ...
      TypingDNA.prototype.removeEventListeners = function() {
        return TypingDNA.removeEventListeners.apply(this, arguments);
      }
      ...
      TypingDNA.removeEventListeners = function() {
        if (TypingDNA.isMobile() === 1) {
          if (TypingDNA.isAndroid()) {
            if (TypingDNA.isFirefox()) {
              TypingDNA.document.removeEventListener("input", TypingDNA.AndroidKeyUp);
              TypingDNA.document.removeEventListener("keydown", TypingDNA.AndroidKeyDown);
            } else {
              TypingDNA.document.removeEventListener("keyup", TypingDNA.AndroidKeyUp);
              TypingDNA.document.removeEventListener("keydown", TypingDNA.AndroidKeyDown);
            }
          } else {
            TypingDNA.document.removeEventListener("keyup", TypingDNA.MobileKeyUp);
            TypingDNA.document.removeEventListener("keydown", TypingDNA.MobileKeyDown);
            TypingDNA.document.removeEventListener("keypress", TypingDNA.MobileKeyPress);
          }
          if (window.DeviceMotionEvent !== undefined) {
            window.removeEventListener('devicemotion', TypingDNA.deviceMotionHandler);
          }
        } else {
          if (TypingDNA.document.removeEventListener) {
            ...
            TypingDNA.document.removeEventListener("mousemove", TypingDNA.mouseMove);
            TypingDNA.document.removeEventListener("mousedown", TypingDNA.mouseDown);
            TypingDNA.document.removeEventListener("mouseup", TypingDNA.mouseUp);
            TypingDNA.document.removeEventListener("scroll", TypingDNA.mouseScroll);
          } else if (TypingDNA.document.detachEvent) {
            TypingDNA.document.detachEvent("onkeyup", TypingDNA.keyUp);
            TypingDNA.document.detachEvent("onkeydown", TypingDNA.keyDown);
            TypingDNA.document.detachEvent("onkeypress", TypingDNA.keyPress);
            TypingDNA.document.detachEvent("onmousemove", TypingDNA.mouseMove);
            TypingDNA.document.detachEvent("onmousedown", TypingDNA.mouseDown);
            TypingDNA.document.detachEvent("onmouseup", TypingDNA.mouseUp);
            TypingDNA.document.detachEvent("onscroll", TypingDNA.mouseScroll);
          } else {
            console.log("browser not supported");
          }
        }
       ...
       * @example var length = tdna.getLength("0,3.2,0,0,1,1091545568,0,-1,-1,0,-1,-1,0,-1,-1,2,76,13,2,105,44,1,0,0,1,1,1,902248182,11,1,0,0,0,1,2048,1152,1,0,76,0,2053506419|13436,101");
       */
